...
public static class AudioFidelity
{
    ...
    /// <see cref="SpeechDenoiser"/> carries, although this is not cheap: it runs thousands of
    /// transforms per gated file, which is the bulk of the measurement's cost. It stays here anyway
    /// because the price is paid at most once per file, and only by a file whose transcripts already
